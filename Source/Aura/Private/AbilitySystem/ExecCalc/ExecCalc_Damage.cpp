	...
	FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	UAuraAbilitySystemLibrary::SetIsBlockedHit(EffectContextHandle, bBlocked);
		/* End of Block Chance Implementation */

	
		/* Armor & Armor Penetration Implementation */
	...
	//TODO: Care that SourceArmorPenetration value must not higher than 400. Handle this issue.
	...
	Damage *= (100 - EffectiveArmor * EffectiveArmorCoefficient) / 100.f;
		/* End of Armor & Armor Penetration Implementation */
	...
	UAuraAbilitySystemLibrary::SetIsCriticalHit(EffectContextHandle, bIsCriticalHit);
		/* End of Critical Hit Implementation */
